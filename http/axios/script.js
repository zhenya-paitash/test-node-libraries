...
function addTodo() {
  ...
  axios
    .post('https://jsonplaceholder.typicode.com/todos', { title: 'Hi',completed: false })
    .then(res => showOutput(res))
    .catch(err => console.error(err));
}
...
function updateTodo() {
  axios
    // .put(`https://jsonplaceholder.typicode.com/todos/${1}`, { title: 'UDP Hi', completed: true })
...
function errorHandling() {
  axios
    .get('https://jsonplaceholder.typicode.com/todosXXX', {
